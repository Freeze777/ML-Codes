...
import graphlab
graphlab.product_key.set_product_key('0711-C5F1-A17C-3419-4545-4AD5-E357-F296')
...
print "Percentage of safe loans  :", round(len(safe_loans_raw)*100.0/(len(safe_loans_raw)+len(risky_loans_raw)),0)
print "Percentage of risky loans :", round(len(risky_loans_raw)*100.0/(len(safe_loans_raw)+len(risky_loans_raw)),0)
...
len(validation_data[validation_data['safe_loans']==-1 and validation_data['prediction']==+1])
...
print len(validation_data[validation_data['safe_loans']==+1 and validation_data['prediction']==-1])
print len(validation_data[validation_data['safe_loans']==+1 and validation_data['prediction']==+1])
